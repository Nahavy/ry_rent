...
Citizen.CreateThread(function()
    while true do 
        Citizen.Wait(5) --with this change the script stops consuming cpu while it is not in use
        sleep = true
        ...
        if sleep then
            Citizen.Wait(1000) -- with this change the script stops consuming cpu while it is not in use
        end
    end
end)
